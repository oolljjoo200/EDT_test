...
Процедура СформироватьСсылку(Команда)
	...
	ПараметрыФормы = Новый Структура("Контрагент", Объект.Покупатель);
	ОткрытьФорму("Документ.Заказ.Форма.ФормаПодготовкиПлатежнойСсылки", ПараметрыФормы,ЭтотОбъект,,,,,Режим);
